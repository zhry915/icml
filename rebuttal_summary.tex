...
\begin{figure}[h]
    ...
    \caption{\textbf{Extreme Sequence Length Analysis.} PGF successfully trains on ultra-long sequences (1M+ tokens) with a stable memory consumption of \textbf{$\sim$1.1 GB}. The loss rapidly decreases from \textbf{16.8} to \textbf{6.7}, demonstrating successful optimization in regimes entirely inaccessible to standard Autograd-based Mamba implementations.}
\end{figure}
